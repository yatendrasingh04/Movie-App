        ...
        <div className="movies-list">
          {this.state.movies.map((movieElem) => (
            ...
            >
              ...
              <h6 className="card-title releas_date">Release:{movieElem.release_date}</h6>
              <h6 className="card-title rating">Rating:{movieElem.vote_average}</h6>
              ...
              >
                {this.state.hover == movieElem.id && (
                  ...
                  >
                    {this.state.favourites.includes(movieElem.id)
